...
const ConfigurationsScreen = ({ navigation }) => {
    ...
    const options =
        [
            { title: 'Sample', image: require('@assets/images/Home/options/crm/enquiry_register.png'), onPress: () => navigation.navigate('') },
            { title: 'Sample', image: require('@assets/images/Home/options/crm/lead.png'), onPress: () => navigation.navigate('') },
            { title: 'Sample', image: require('@assets/images/Home/options/crm/pipeline.png'), onPress: () => navigation.navigate('') },
        ]
